...
<head>
    ...
    <!--<link rel="stylesheet" type="text/css" href="%root_path%assets/css/amazeui.min.css" > -->
    <link rel="stylesheet" type="text/css" href="%root_path%assets/css/autoc.css" >
...
.sdsm-menu li.active {
    ...
    <script src="%root_path%assets/js/autoc.min.js"></script>
    <script type="text/javascript">
